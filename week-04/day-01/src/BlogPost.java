public class BlogPost {
  ...
  public static void main(String[] args) {
    ...
    BlogPost second = new BlogPost("Tim Urban", "Wait but why", "A popular long-form, stick-figure" +
            "-illustrated blog about almost everything.", "2010.10.10");
    BlogPost third = new BlogPost("William Turton", "One Engineer Is Trying to Get IBM to Reckon With " +
